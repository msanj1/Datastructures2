...
namespace Traversals
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine(String.Join(" ",tree.TraverseInOrder().Select(x=>x.Key)));
            Console.WriteLine(String.Join(" ", tree.TraversePreOrder().Select(x => x.Key)));
            Console.WriteLine(String.Join(" ", tree.TraversePostOrder().Select(x => x.Key)));
        }
    }
}
